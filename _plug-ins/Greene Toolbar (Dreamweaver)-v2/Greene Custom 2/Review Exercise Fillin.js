...
var retVal='\n'+
  ...
  '<form name="fillForm'+Form.QuestionNumber.value+'" onSubmit="return false">\n'+
    '<input type="text" name="fillAnswer'+Form.QuestionNumber.value+'" class="fillInSpace"><br/>\n'+
    '<input type="button" name="buttonCheckQ" onClick="return fill_buttonCheckQ_onclick('+Form.QuestionNumber.value+', window.document.fillForm'+Form.QuestionNumber.value+'.fillAnswer'+Form.QuestionNumber.value+')" value="SUBMIT" class="submit-btn">\n'+
  '</form>\n'+
  '<script>\n'+
  '<!--\n'+
