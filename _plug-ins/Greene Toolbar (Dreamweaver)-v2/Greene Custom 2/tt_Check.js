...
'   {\n'+
'      questionHTML = questionHTML + "<label><INPUT TYPE=checkbox NAME=checkQuestionChoice" +questionChoice+ ">" + "&nbsp;&nbsp;";\n'+
...
var retVal='\n'+
  ...
  '//-->\n'+
  '</SCRIPT>\n'+
  '<BR><INPUT TYPE="button" class="submit-btn-ckbox" VALUE="SUBMIT" Name="buttonCheckQ" onclick="return check_buttonCheckQ('+Form.QuestionNumber.value+', window.document.checkForm'+Form.QuestionNumber.value+')">\n'+
  '</FORM>\n'+ 
  '<script>\n'+
  '<!--\n'+
